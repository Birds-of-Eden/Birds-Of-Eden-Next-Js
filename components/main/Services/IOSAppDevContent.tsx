// components/IOSAppDevContent.tsx (CSR Component)
"use client";

interface IOSAppDevContentProps {
  title: string;
  header: string;
...
const IOSAppDevContent: React.FC<IOSAppDevContentProps> = ({
  title,
  header,
  list,
  footer,
...
export default IOSAppDevContent;
