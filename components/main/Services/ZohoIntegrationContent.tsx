// components/ZohoIntegrationContent.tsx (CSR Component)
"use client";

interface ZohoIntegrationContentProps {
  title: string;
  description: string;
...
const ZohoIntegrationContent: React.FC<ZohoIntegrationContentProps> = ({
  title,
  description,
  list,
  footer,
...
export default ZohoIntegrationContent;
